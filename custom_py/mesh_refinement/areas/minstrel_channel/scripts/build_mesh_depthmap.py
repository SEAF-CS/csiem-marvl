...
LATMIN,LATMAX=-32.276,-32.240; LONMIN_A,LONMAX_A=115.672,115.718   # area of interest (minstrel)
VMIN,VMAX=-14,-2                    # brightened colour range (minstrel sill)
# mesh
nodes={}; elems=[]
with open(MESH) as f:
    for line in f:
...
plt.colorbar(pc,ax=ax,shrink=0.6,label="cell_Zb (m)  [clamped -14..-2]")
ax.set_title("Model mesh cell depth (cell_Zb) — Minstrel channel, S of Garden Island\nlat -32.276..-32.240, N up",fontsize=11)
