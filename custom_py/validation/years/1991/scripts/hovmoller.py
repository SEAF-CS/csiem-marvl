...
import tfv.xarray
import sys as _vsys, os as _vos; _vsys.path.insert(0, _vos.path.abspath(_vos.path.join(_vos.path.dirname(__file__), '..', '..', '..', 'common', 'lib')))
...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'outputs', 'hovmoller_ST_CS55_OA80_1991_rev.png')
