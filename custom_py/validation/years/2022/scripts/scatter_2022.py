# Point-by-point obs-vs-model scatter for 2022 (1991-style; map-plot composite
# sources; day/depth-matched). Thin wrapper over common/lib/scatter_modern.py.
import os, runpy
from pathlib import Path

_default = '2022B' if os.environ.get('MODEL_VER', '1.8.0').startswith('1.8') else ('2022A' if '2022' in ('2013', '2015') else '2022B')
