...
MODEL_NC = Path(r'S:/Matt_Working/csiem/output_archive/1.7.0/1991_aug_rev/csiem_B010_19910720_19910831_rev.nc')  # REV
...
OUT_DIR = Path(r'G:/CSIEM/1.8.0/csiem-marvl/custom_py/dadamo_transect/outputs_1991_TransectA_compare_rev')  # REV
...
def model_profiles_at(model_date):
    ...
    for stn in MODEL_STATIONS:
        ...
        try:
            ...
            den=np.asarray(pt['RHOW']).ravel()-1000.0   # sigma_t
