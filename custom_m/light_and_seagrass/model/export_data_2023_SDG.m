...
ncfile(1).name='W:\csiem\Model\TFV\csiem_model_tfvaed_1.1\outputs\results\tests_PH_map_light2_OASIM_2023_output1_WQ.nc';
...
save('extracted_2023_half.mat','output','-mat','-v7.3');

else
    load extracted_2023_half.mat;
end
