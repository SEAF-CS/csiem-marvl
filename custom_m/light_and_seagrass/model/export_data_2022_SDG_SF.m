...
ncfile(1).name='W:\csiem\Model\TFV\csiem_model_tfvaed_1.1\outputs\results\tests_PH_map_light2_OASIM_restart_newtest_WQ.nc';
...
for ll=1:length(allvars)
    ...
    if any([strfind(loadname,'_SF')])                     %strfind(loadname,'OAS')
...
save('extracted_2022_restart_newtestv2_SF.mat','output','-mat','-v7.3');
