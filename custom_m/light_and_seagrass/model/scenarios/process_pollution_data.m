...
data_dredge=load('W:\csiem\Model\TFV\export\extracted_bottom_light_2022_restart_08_pollution70s_IOPs_wholeYear.mat');
data_ori=load('W:\csiem\Model\TFV\export\extracted_bottom_light_2022_restart_08_IOPs_wholeYear.mat');
...
cellx=dat.cell_X;
celly=dat.cell_Y;
incells=inpolygon(cellx,celly,shp(2).X,shp(2).Y);
...
save('extracted_pollution_scens_totallynopollution_v3_2022.mat','WQ*','-mat','-v7.3');
