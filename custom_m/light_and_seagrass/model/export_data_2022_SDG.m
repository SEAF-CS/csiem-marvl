clear; close all;
addpath(genpath('.\seagrass\aed-marvl\'))

ncfile(1).name='W:\csiem\Model\TFV\csiem_model_tfvaed_1.1\outputs\results\tests_PH_map_light2_OASIM_2023_restart_08_WQ.nc';
...
for ll=1:length(allvars)
    ...
    if any([strfind(loadname,'WQ_OGM_DOC'),   strfind(loadname,'WQ_NCS_SS1'), ...
            ...
            strfind(loadname,'A_IOP'), strfind(loadname,'_SF')])                     %strfind(loadname,'OAS')
...
save('extracted_2023_SALCH4.mat','output','-mat','-v7.3');
