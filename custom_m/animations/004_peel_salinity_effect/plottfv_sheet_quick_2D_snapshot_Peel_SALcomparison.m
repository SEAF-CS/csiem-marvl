...
noGWfile=[inDir,'csiem_v1_B009_20130101_20131231_HD_CLN2_W14.nc'];
GWfile=[inDir,'csiem_v1_B009_20130101_20131231_HD_CLN2_W14_Peel.nc'];
...
t1=datenum('20110210 00:00','yyyymmdd HH:MM');
...
for i=tt:plot_interval:tt1
   ...
   % ind0=find(abs(timesteps_met-t0)==min(abs(timesteps_met-t0)));
    ...
    tdat = tfv_readnetcdf(noGWfile,'timestep',i);
  %  Wx=tdat.W10_x;
  %  Wy=tdat.W10_y;
