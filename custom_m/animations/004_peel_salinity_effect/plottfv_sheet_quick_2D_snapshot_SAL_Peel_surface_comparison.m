...
inDir='/Projects2/csiem/model/csiem_model_tfvaed_2.0/output_archive/results/';
...
WQfile=[inDir,'csiem_B009_20221101_20240401_ECOb.nc'];
WQfile2=[inDir,'csiem_B009_20221101_20240401_ECOb.nc'];
...
sim_name = [img_dir,'animation_peel_salinity.avi'];
...
hfig = figure('visible','on','position',[304         166         1250        875]);

set(gcf, 'PaperPositionMode', 'manual');
set(gcf, 'PaperUnits', 'centimeters');
set(gcf,'paperposition',[0.635 6.35 24 15.5])

t0=datenum('20230101 00:00','yyyymmdd HH:MM');
tt = find(abs(timesteps_WQ-t0)==min(abs(timesteps_WQ-t0)));
t1=datenum('20240215 00:00','yyyymmdd HH:MM');
...
for i=tt:plot_interval:tt1
   ...
   cdata1=tdat.DENSITY(surf_cells); %sqrt(Wx.^2+Wy.^2);
   % d=tdat.D;
