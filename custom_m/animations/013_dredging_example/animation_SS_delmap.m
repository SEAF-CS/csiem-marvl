...
WQfile=[inDir,'csiem_v1_C001_20220101_20221231_WQ_highRes_dredge_highRes.nc'];
wavefile=[inDir,'csiem_v1_C001_20220101_20221231_WQ_highRes_nodredge_highRes.nc'];
...
img_dir = '.\animation_SS_delmap_uncompressed\';
...
%hold on;
    ...
    title('\DeltaSS (dredge - no dredge)','color','k','fontsize',10);hold on;
