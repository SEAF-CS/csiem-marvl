...
data1= tfvscale.output.(sitenames{ss}).WVHT.Data;
...
hl=legend('WWM','CSIEM','ADV','Position',[0.4 0.03 0.2 0.03],'NumColumns',5);
set(hl,'Position')

img_name =['wave_tfv_calibration_timeseries_2023_',sitenames{ss},'_scaled.png'];
