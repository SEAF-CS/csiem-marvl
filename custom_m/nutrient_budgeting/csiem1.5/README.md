 ...
 Ensure the required files are available. Required fiels are:

 - Nodestring output
 - Netcdf out containing vars and rquired bathy info.
 - varlist in export code.
 ...
 ### step 1: 
  ...
  export the included nutrient variables and saved in MAT format for next step processing
   ...
   Configure the varlist exporter and make sure correct is referenced in matfile exporter.

   Check that the correct gis file is used for extraction.
