...
%
% step 2: preprocessing the MPB variables for next step by runing the 
...
%
% step 5: define the nitrogen variables to be included in the pool and flux plots and then 
%         do the nitrogen budgeting and plot by running the 'cal_nitrogen_budget_hchb_5panels_2022_final.m'
%         script.
%
% step 6: define the phosphorus variables to be included in the pool and flux plots and then 
