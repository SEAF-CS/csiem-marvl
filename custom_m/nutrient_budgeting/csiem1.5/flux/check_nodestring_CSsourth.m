...
save('processed_vx_south.mat','Vx','time','-mat','-v7.3');
else
load('processed_vx_south.mat');
end
...
datearray=datenum(2022,12,1:5:21);

yyaxis left;
plot(flux.CS_shelf.mDate,-flux.CS_shelf.Flow);
hold on;
plot(flux.CS_south.mDate,-flux.CS_south.Flow);
hold on;
plot(flux.CS_south.mDate,flux.CS_south.Flow*0);
hold on;
ylim([-2000 2000])
...
legend('NS-shelf','NC-south','zero','Vx');

img_name ='check_nodestring_CSsouth.png';
