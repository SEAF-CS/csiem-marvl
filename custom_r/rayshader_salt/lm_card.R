...
for (th in c(0,90,180,270)) {
  plot_3d(tex,elmat,zscale=ZSCALE,fov=0,theta=th,phi=45,windowsize=c(1100,950),zoom=0.6,water=FALSE); Sys.sleep(0.15)
  render_camera(theta=th,phi=45,zoom=0.6,fov=0)
  render_snapshot(sprintf("images/card_th%03d.png",th),clear=FALSE); rgl::clear3d(); cat("theta",th,"\n")
}
rgl::close3d()
