...
master.ncfile(1).name = '/Projects2/csiem/model/csiem_model_tfvaed_2.0/model_components/outputs/results/csiem_A001_20221101_20240401_ECO_WQ.nc';
master.ncfile(1).legend = 'ECO06';
master.ncfile(1).tag = 'TFVc';

%master.ncfile(3).name = '/Projects2/csiem/model/csiem_model_tfvaed_2.0/model_components/outputs/results/csiem_A001_20221101_20240401_ECO_WQ.nc';
%master.ncfile(3).legend = 'ECO06';
...
timeseries.outputdirectory  = '../../outputs/002_2.0_comparison/00c/RAW/';% specify the
timeseries.htmloutput       = '../../outputs/002_2.0_comparison/00c/HTML/';
timeseries.ErrFilename      = '../../outputs/002_2.0_comparison/00c/errormatrix.mat';
...
%
% -------------------------------------------------------------------------
timeseries.datearray = datenum(2022,10:3:28,1); %datenum(2022,11:3:29,1);
