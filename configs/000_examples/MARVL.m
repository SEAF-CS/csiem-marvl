...
timeseries.outputdirectory = '/Projects2/csiem/csiem-marvl-clean/outputs/timeseries_2022/RAW/';
timeseries.htmloutput = '/Projects2/csiem/csiem-marvl-clean/outputs/timeseries_2022/HTML/';
timeseries.ErrFilename = '/Projects2/csiem/csiem-marvl-clean/outputs/timeseries_2022/errormatrix.mat';
...
% ___
transect.outputdirectory = '/Projects2/csiem/csiem-marvl-clean/outputs/transect_2022/RAW/';
transect.htmloutput = '/Projects2/csiem/csiem-marvl-clean/outputs/transect_2022/HTML/';
...
for i=1:7
transect.pdates(i).value = [datenum(2022,04,1+(i-1)*5) datenum(2022,04,1+i*5)];
end
...
sheet.outputdirectory = '/Projects2/csiem/csiem-marvl-clean/outputs/sheet_TEMP/';
...
curtain.outputdirectory = '/Projects2/csiem/csiem-marvl-clean/outputs/curtain_TEMP/';
...
% ___
transectSA.outputdirectory = '/Projects2/csiem/csiem-marvl-clean/outputs/transectSA/RAW/';
transectSA.htmloutput = '/Projects2/csiem/csiem-marvl-clean/outputs/transectSA/HTML/';
...
profile.outputdirectory = '/Projects2/csiem/csiem-marvl-clean/outputs/profile/RAW/';
profile.htmloutput = '/Projects2/csiem/csiem-marvl-clean/outputs/profile/HTML/';
...
transectExc.thresh(14).legend = {'%time > 1.2 mg/L',...
    '%time > 1.6 mg/L'};
% ___
transectExc.outputdirectory = '/Projects2/csiem/csiem-marvl-clean/outputs/transect_exceedance/RAW/';
transectExc.htmloutput = '/Projects2/csiem/csiem-marvl-clean/outputs/transect_exceedance/HTML/';
...
boxchartConf.outputdirectory = '/Projects2/csiem/csiem-marvl-clean/outputs/boxchart2/RAW/';
