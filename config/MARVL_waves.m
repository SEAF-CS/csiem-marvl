...
% Models
master.ncfile(1).name = '/Projects2/csiem/Model/TFV/csiem_model_tfvaed_1.0/tfvaed_1.0/outputs/results_wrf/csiem_100_A_20220101_20221231_WQ_009_WWM_WRF_GW_wave.nc';
...
master.ncfile(1).legend = 'WRFWWM-2022';
master.ncfile(1).tag = 'TFV';

% field data
master.add_fielddata = 1;
master.fielddata_matfile = '../data/WWM_waves_2022.mat';
master.fielddata = 'wavesCS'; %'swan';
...
timeseries.polygon_file = '../gis/MLAU_Zones_v1_ll.shp';
...
timeseries.outputdirectory = '../outputs/timeseries_tailor_2022_waves/RAW/';
timeseries.htmloutput = '../outputs/timeseries_tailor_2022_waves/HTML/';
timeseries.ErrFilename = '../outputs/timeseries_tailor_2022_waves/errormatrix.mat';
...
timeseries.datearray = datenum(2022,1:1:4,1);
...
% ___
transect.outputdirectory = '../outputs/transect/RAW/';
transect.htmloutput = '../outputs/transect/HTML/';
...
i=1;
transect.pdates(1).value = [datenum(2013,01,02) datenum(2013,02,01)];i=i+1;
transect.pdates(2).value = [datenum(2013,02,01) datenum(2013,03,01)];i=i+1;
transect.pdates(3).value = [datenum(2013,03,01) datenum(2013,04,01)];i=i+1;
...
boxchartConf.start_plot_ID = 3;
boxchartConf.end_plot_ID = 5;

% reading polygon and NC files, 'W:\' is the 'Projects2' drive
boxchartConf.polygon_file = '.\GIS\MLAU_Zones_v1_ll.shp';
boxchartConf.cattt=["CS01","CS02","CS03","CS04","CS05","CS06","CS07","CS08","CS09","CS10","CS11",...
    "CS12","CS13","CS14","CS15","CS16","CS17","CS18","CS19","CS20","CS21","CS22","CS23",...
    "CS24"];

% time period to extract data
boxchartConf.datearray = [datenum(2013,1,1) datenum(2013,2,1)];
% ylim
for vvvv=1:size(MARVLs.master.varname,1)
    boxchartConf.cAxis(vvvv).value = [0 100];
end
boxchartConf.cAxis(1).value = [0 40];
boxchartConf.cAxis(2).value = [0 40];
boxchartConf.cAxis(3).value = [0 10];
boxchartConf.cAxis(4).value = [0 0.02];
...
boxchartConf.outputdirectory = './Outputs/boxchart/RAW/';
