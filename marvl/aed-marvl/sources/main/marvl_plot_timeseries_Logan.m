function marvl_plot_timeseries_Logan(MARVLs,style)
%**************************************************************************
%
                        ...
                        if strcmpi(layer,'bottom') == 1
                            if fgf > 1
                                fp = plot(xdata_d,ydata_d,mface,'markeredgecolor',...
                                    ...
                                    'black','markersize',5,'HandleVisibility','off');hold on
                                uistack(fp,'top');
                                ...
                                fp = plot(xdata_d,ydata_d,mface,'markeredgecolor',...
                                    edge_color{2},'markerfacecolor','black',...
                                    'markersize',5,'displayname',[agency,' (Bot)']);hold on; %,' Surf'
                                uistack(fp,'top');
                                if config.validation_minmax
                                    fp = plot(xdata_d,ydata_max_d,'+','color',[0.6 0.6 0.6],...
                                        'HandleVisibility','off');hold on
                            ...
                            if fgf > 1
                                fp = plot(xdata_d,ydata_d,mface,'markeredgecolor',...
                                    ...
                                    'black','markersize',6,'HandleVisibility','off');hold on
                                uistack(fp,'top');
                                if config.validation_minmax
                                    fp = plot(xdata_d,ydata_max_d,'+','color',[0.6 0.6 0.6],...
                                        'HandleVisibility','off');hold on
                                ...
                                fp = plot(xdata_d,ydata_d,mface,'markeredgecolor',...
                                    'red','markerfacecolor','black',...
                                    'markersize',5,'displayname',[agency,' (Surf)']);hold on; %,' Surf'
                                uistack(fp,'top');
                                if config.validation_minmax
                                    fp = plot(xdata_d,ydata_max_d,'+','color',[0.6 0.6 0.6],...
                                        'HandleVisibility','off');hold on
