%% stats18 chunk vars 8-14 (per-chunk errormatrix; single-model OOM'd at var 22 unchunked)
...
timeseries.start_plot_ID = 8;
timeseries.end_plot_ID = 14;   % = numel(varname); 31 overran the list and crashed after the last variable
...
timeseries.ErrFilename = '../../outputs/008_1.8_comparison/2022B_stats18/errormatrix_chunk08_14.mat';
