...
timeseries.start_plot_ID = 6;
timeseries.end_plot_ID = 10;   % = numel(varname); 31 overran the list and crashed after the last variable
...
timeseries.ErrFilename = '../../outputs/008_1.8_comparison/2022B/errormatrix_chunk06_10.mat';
