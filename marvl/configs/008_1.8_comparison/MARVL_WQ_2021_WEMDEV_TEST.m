%% TEST variant (2026-09-07): ncfile(2) -> output_archive/_test mid-run copy
%% (covers ~Nov-2020..Jun-2021 only); outputs -> .../TEST/. Plumbing test only
%% - delete this file once the real 1.8 run is validated.
...
master.ncfile(1).name = 'W:\WAMSI\1.7\SH-20251123-1.7.0\2021B-20260131010652\results\csiem_B010_20201101_20211231_WQ_WQ.nc';   % B-mesh 1.7 baseline (was 2021A A-mesh; B mesh throughout, Matt 2026-09-07)
master.ncfile(1).legend = 'csiem1.7.0';
master.ncfile(1).tag = 'TFV';
master.ncfile(2).name = 'Q:\SEAF-CS\V1.8\MODEL\csiem_model_tfvaed_1.8\output_archive\_test\2021B\csiem_B010_20201101_20211231_WQ_WQ.nc';
...
timeseries.outputdirectory = '../../outputs/008_1.8_comparison/TEST/2021A/RAW/';
timeseries.htmloutput = '../../outputs/008_1.8_comparison/TEST/2021A/HTML/';
timeseries.ErrFilename = '../../outputs/008_1.8_comparison/TEST/2021A/errormatrix.mat';
