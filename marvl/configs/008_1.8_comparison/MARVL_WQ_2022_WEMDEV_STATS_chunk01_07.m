%% stats18 chunk vars 1-7 (per-chunk errormatrix; single-model OOM'd at var 22 unchunked)
...
timeseries.end_plot_ID = 7;   % = numel(varname); 31 overran the list and crashed after the last variable
...
timeseries.ErrFilename = '../../outputs/008_1.8_comparison/2022B_stats18/errormatrix_chunk01_07.mat';
