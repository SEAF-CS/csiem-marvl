...
%master.ncfile(1).name = 'W:\WAMSI\1.7\SH-20251123-1.7.0\2022B-20260131015416\results\csiem_B010_20211101_20221231_WQ_WQ.nc';   % B-mesh 1.7 baseline (was 2021A A-mesh; B mesh throughout, Matt 2026-09-07)  % dropped for stats pass: errorMatrix scores ncfile(1) only
%master.ncfile(1).legend = 'csiem1.7.0';
%master.ncfile(1).tag = 'TFV';
master.ncfile(1).name = 'W:\WAMSI\1.7\SH-20251123-1.7.0\2022B-20260131015416\results\csiem_B010_20211101_20221231_WQ_WQ.nc';
master.ncfile(1).legend = 'csiem1.7.0';
master.ncfile(1).tag = 'TFV';
...
timeseries.outputdirectory = '../../outputs/008_1.8_comparison/2022B_stats17/RAW/';
timeseries.htmloutput = '../../outputs/008_1.8_comparison/2021A/HTML/';
timeseries.ErrFilename = '../../outputs/008_1.8_comparison/2022B_stats17/errormatrix.mat';
