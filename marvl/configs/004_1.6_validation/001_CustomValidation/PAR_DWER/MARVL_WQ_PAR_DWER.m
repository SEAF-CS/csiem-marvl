...
% Models
master.ncfile(1).name = 'W:\WAMSI\1.7\SH-20251121-1.7.test\2023A-20251121074816\results\csiem_A001_20221101_20240401_WQ_WQ.nc';
master.ncfile(1).legend = 'csiem1.7 -2023';
...
timeseries.outputdirectory = '../../../../outputs/001_ValidationSnapshot/PAR_DWER/RAW/';
timeseries.htmloutput = '../../../../outputs/001_ValidationSnapshot/PAR_DWER/HTML/';
timeseries.ErrFilename = '../../../../outputs/001_ValidationSnapshot/PAR_DWER/errormatrix.mat';
...
timeseries.datearray = datenum(2022,11:3:21,1);
...
% ylim
 for vvvv=1:size(MARVLs.master.varname,1)
     ...
     timeseries.cAxis(1).value = [0 300];
 end
