...
if timeseries.plotAllsites == 0
   % timeseries.plotsite = [6 10 29];
    timeseries.plotsite = [35 43 44 52 54];
end
...
timeseries.outputdirectory = '../../../outputs/001_ValidationSnapshot/WWMSP3.1.3_SEDDEP/RAW/';
timeseries.htmloutput = '../../../outputs/001_ValidationSnapshot/WWMSP3.1.3_SEDDEP/HTML/';
timeseries.ErrFilename = '../../../outputs/001_ValidationSnapshot/WWMSP3.1.3_SEDDEP/errormatrix.mat';
...
timeseries.datearray = datenum(2023,1:2:11,1);
