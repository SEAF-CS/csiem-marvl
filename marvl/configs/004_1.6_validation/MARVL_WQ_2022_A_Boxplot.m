...
% Models
master.ncfile(1).name = '../../../outputs/results/2022A/csiem_A001_20211101_20221231_WQ_WQ.nc';
...
master.fielddata_matfile = '../../../csiem-data/data-warehouse/mat/agency/csiem_DWER_public_reduced50.mat';
...
boxchartConf.polygon_file = '../../gis/zones/MLAU_Zones_v2_ll.shp';
...
boxchartConf.datearray = [datenum(2022,4,1) datenum(2022,5,1)];
% ylim
for vvvv=1:size(MARVLs.master.varname,1)
