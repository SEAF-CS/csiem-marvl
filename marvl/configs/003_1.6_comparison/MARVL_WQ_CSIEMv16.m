...
master.ncfile(1).legend = 'csiem 1.6 aed';
master.ncfile(1).tag = 'TFVb';
    
master.ncfile(2).name = '/Projects2/csiem/model/csiem_model_tfvaed_1.6/outputs/results/csiem_A001_20201101_20211231_WQ_WQ.nc';
master.ncfile(2).legend = 'csiem 1.6 new';
master.ncfile(2).tag = 'TFVb';

%master.ncfile(3).name = '/Projects2/csiem/model/csiem_model_tfvaed_1.6/outputs/sh/csiem_A001_20221101_20240401_WQ_WQ.nc';
%master.ncfile(3).legend = 'csiem 1.6 sh';
%master.ncfile(3).tag = 'TFVc';

%master.ncfile(3).name = '/Projects2/csiem/model/_archive_20250715/TFV/csiem_model_tfvaed_2.0/outputs/results/csiem_A001_20221101_20240401_ECO05_WQ.nc';
%master.ncfile(3).legend = 'ECO05';
%master.ncfile(3).tag = 'TFVc';
...
master.fielddata_folder = '/Projects2/csiem/csiem-marvl-dev/data/2025024/';    
master.fielddata_files  = {'csiem_CSMC_public','csiem_DWER_public_reduced50','csiem_DPIRD_public','csiem_WCWA_public','csiem_WAMSI_public','csiem_IMOS_public_reduced50'}; %{'csiem_CSMC_public','csiem_WAMSI_public'};
...
timeseries.outputdirectory  = '../../outputs/003_1.6_comparison/00c/RAW/';% specify the
timeseries.htmloutput       = '../../outputs/003_1.6_comparison/00c/HTML/';
timeseries.ErrFilename      = '../../outputs/003_1.6_comparison/00c/errormatrix.mat';
...
%
% -------------------------------------------------------------------------
timeseries.datearray = datenum(2020,11:1:54,1); %datenum(2022,11:3:29,1);
