...
master.varname = {...
     'TEMP','Temperature (°C)'; ...
     'SAL','Salinity (psu)'; ...
    % 'WQ_DIAG_TOT_PAR','PAR (µE m^-2 s^-1)'; ...
...
timeseries.end_plot_ID = size(MARVLs.master.varname, 1);
...
if timeseries.plotAllsites == 0
    timeseries.plotsite = [6 10 11 13 26 28 29 30 32 35 36 37 40 42 43 44 48 68 70 72];
end
