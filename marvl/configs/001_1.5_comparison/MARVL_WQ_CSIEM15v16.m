...
%master.ncfile(2).name = '/Projects2/csiem/model/csiem_model_tfvaed_1.6/outputs/results/csiem_A001_20221101_20240401_WQ_WQ.nc';
%master.ncfile(2).legend = 'csiem 1.6 aed';
...
timeseries.outputdirectory  = '../../outputs/001_1.5_comparison/00c/RAW/';% specify the
timeseries.htmloutput       = '../../outputs/001_1.5_comparison/00c/HTML/';
timeseries.ErrFilename      = '../../outputs/001_1.5_comparison/00c/errormatrix.mat';
...
%
% -------------------------------------------------------------------------
timeseries.datearray = datenum(2022,11:1:16,1); %datenum(2022,11:3:29,1);
