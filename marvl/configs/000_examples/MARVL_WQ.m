...
% Models
master.ncfile(1).name = 'anything.nc';
...
master.fielddata_files  = {'csiem_WCWA_public'};
...
timeseries.outputdirectory = '../../outputs/WCWADO/RAW/';
timeseries.htmloutput = '../../outputs/WCWADO/HTML/';
timeseries.ErrFilename = '../../outputs/WCWADO/errormatrix.mat';
...
timeseries.datearray = datenum(2013,1:3:13,1);
