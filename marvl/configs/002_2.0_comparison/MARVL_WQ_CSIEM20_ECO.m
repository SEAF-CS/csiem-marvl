...
%
% List here the desired MARVL modules, state variables, model outputs,
...
%--------------------------------------------------------------------------
  master.varname = {...
    ...
    'WQ_DIAG_TOT_PAR','TOT-PAR';...
  	'WQ_DIAG_BIV_TBIV','TBIV';...
  	'WQ_DIAG_PHY_MPB_BEN','MPB-BEN';...
	'WQ_DIAG_MAC_MAC_BEN','MAC-BEN';...
	'WQ_DIAG_MAC_EPI_BEN','EPI-BEN';...
	'WQ_DIAG_MAG_MAG_BEN','MAG-BEN';...
    ...
    'WQ_DIAG_TOT_PAR','TOT-PAR';...
    'WQ_DIAG_MAC_PAR','MAC-PAR';...
	'WQ_DIAG_MAC_MAC_BEN','MAC-BEN';...
	'WQ_DIAG_MAC_MAC_AG','MAC-AG';...
	'WQ_DIAG_MAC_MAC_BG','MAC-BG';...
	'WQ_DIAG_MAC_MAC_FR','MAC-Fruit';...
	'WQ_OGM_POC','POC';...
    'WQ_OGM_DOC','DOC';...
    'WQ_OGM_POP','POP';...
    'WQ_OGM_DOP','DOP';...
    ...
    'WQ_DIAG_PHY_SET','PHYSET';...
	'WQ_DIAG_PHY_PHY_SWI_C','PHYSWIC';...
	...
	'WQ_DIAG_NIT_DIN_ATM','DINATM';...
	'WQ_DIAG_PHS_FRP_DSF','FRPDSF';...
	'WQ_DIAG_PHS_DIP_ATM','DIPATM';...
	'WQ_DIAG_OGM_POC_SET','POCSET';...
	'WQ_DIAG_OGM_PON_SET','PONSET';...
	'WQ_DIAG_OGM_POC_HYD','POCHYD';...
	'WQ_DIAG_TOT_LIGHT','TOT-LIGHT';...
    'WQ_DIAG_TOT_EXTC','TOT-EXTC';...
    };
master.add_human = 1; % option to use user-defined names, if 0 use AED names

% model selection: --------------------------------------------------------
%
%--------------------------------------------------------------------------

%master.ncfile(1).name = '/Projects2/csiem/model/_archive_20250715/TFV/csiem_model_tfvaed_1.5_clean/outputs/results/final/AGrid/csiem_A001_20221101_20240401_WQ_WQ.nc';
%master.ncfile(1).legend = 'csiem 1.5 ph';
%master.ncfile(1).tag = 'TFVa';

%master.ncfile(1).name = '/Projects2/csiem/model/csiem_model_tfvaed_2.0/model_components/outputs/results/csiem_A001_20221101_20240401_WQ_WQ.nc';
%master.ncfile(1).legend = 'csiem 2.0 a';
%master.ncfile(1).tag = 'TFVb';
    
%master.ncfile(2).name = '/Projects2/csiem/model/csiem_model_tfvaed_1.6/outputs/results/csiem_B009_20221101_20240401_WQ_WQ.nc';
%master.ncfile(2).legend = 'csiem 1.6 B';
%master.ncfile(2).tag = 'TFVb';

%master.ncfile(5).name = '/Projects2/csiem/model/csiem_model_tfvaed_2.0/model_components/outputs/results/csiem_A001_20221101_20240401_ECO_WQ.nc';
%master.ncfile(5).legend = 'ECO06';
%master.ncfile(5).tag = 'TFVc';

master.ncfile(3).name = '/Projects2/csiem/model/csiem_model_tfvaed_2.0/output_archive/results/csiem_A001_20221101_20240401_ECOb_WQ.nc';
master.ncfile(3).legend = 'ECO06b-A';
master.ncfile(3).tag = 'TFVc';

master.ncfile(2).name = '/Projects2/csiem/model/csiem_model_tfvaed_2.0/output_archive/results/csiem_B009_20221101_20240401_ECOb_WQ.nc';
master.ncfile(2).legend = 'ECO06b-B';
master.ncfile(2).tag = 'TFVc';

master.ncfile(1).name = '/Projects2/csiem/model/csiem_model_tfvaed_2.0/output_archive/results/csiem_A001_20221101_20240401_ECO_bivfb_WQ.nc';
master.ncfile(1).legend = 'ECO06b-BIVFB';
master.ncfile(1).tag = 'TFVc';


% field data selection: ---------------------------------------------------
%
%--------------------------------------------------------------------------
master.add_fielddata    = 0;
master.fielddata_folder = '/Projects2/csiem/csiem-marvl-dev/data/20250424/';    
master.fielddata_files  = {'csiem_CSMC_public','csiem_WAMSI_public'};
%{'csiem_CSMC_public','csiem_DWER_public_reduced50','csiem_DPIRD_public','csiem_WCWA_public','csiem_WAMSI_public','csiem_IMOS_public_reduced50'};
%{'csiem_IMOS_public','csiem_DWER_public','csiem_DPIRD_public','csiem_CSMC_public','csiem_WCWA_public','csiem_WAMSI_public','csiem_BOM_public','csiem_DOT_public'}; 'csiem_IMOS_public_reduced50',,'csiem_ESA_bysite_public','csiem_NASA_bysite_public','csiem_MOI_bysite_public'
...
%% timeseries setting: ----------------------------------------------------
%
%  The is the configuration for the marvl_plot_timeseries.m function
% -------------------------------------------------------------------------

timeseries.start_plot_ID  = 1;
timeseries.end_plot_ID    = 55;
...
timeseries.plotdepth      = {'bottom'};  %  {'surface','bottom'} Cell-array with either one
timeseries.depthTHRESH    =  5;           %  {'surface','bottom'} Cell-array with either one
...
timeseries.polygon_file   = '/Projects2/csiem/csiem-marvl-dev/gis/MLAU_Zones_v3_ll.shp';
timeseries.plotAllsites   = 0;
if timeseries.plotAllsites == 0
   %timeseries.plotsite   = [6 10 29];
    timeseries.plotsite   = [1:29];
end
...
timeseries.outputdirectory  = '../../outputs/002_2.0_comparison/00f/RAW/';% specify the
timeseries.htmloutput       = '../../outputs/002_2.0_comparison/00f/HTML/';
timeseries.ErrFilename      = '../../outputs/002_2.0_comparison/00f/errormatrix.mat';
...
% === Dataset 2 (new colors: teal and goldenrod) ===
timeseries.ncfile(2).symbol = {'-'; '-'};
timeseries.ncfile(2).colour = {[31,120,180]./255; [253,191,111]./255}; % Surface and Bottom
timeseries.ncfile(2).col_pal_color_surf = [[198,219,239]./255; [158,202,225]./255]; % color1: 5-95 perc; color2: 25-75 perc
timeseries.ncfile(2).col_pal_color_bot  = [[255,237,160]./255; [254,178,76]./255];

% === Dataset 3 (new colors: dark green and magenta) ===
timeseries.ncfile(3).symbol = {'-'; '-'};
timeseries.ncfile(3).colour = {[0,109,44]./255; [197,27,138]./255}; % Surface and Bottom
timeseries.ncfile(3).col_pal_color_surf = [[199,233,192]./255; [161,217,155]./255]; % color1: 5-95 perc; color2: 25-75 perc
timeseries.ncfile(3).col_pal_color_bot  = [[241,238,246]./255; [212,185,218]./255];

% === Dataset 4  ===
timeseries.ncfile(4).symbol = {'-';'-'};
timeseries.ncfile(4).colour = {[255,127,0]./255;[255,255,51]./255};% Surface and Bottom
timeseries.ncfile(4).col_pal_color_surf =[[255,127,0]./255;[255,255,51]./255]; % color1: 5-95 perc; color2: 25-75 perc
timeseries.ncfile(4).col_pal_color_bot  =[[255,127,0]./255;[255,255,51]./255];

%% plotting configuration: ------------------------------------------------
%
% -------------------------------------------------------------------------
timeseries.datearray = datenum(2022,10:3:22,1); %datenum(2022,11:3:29,1);
