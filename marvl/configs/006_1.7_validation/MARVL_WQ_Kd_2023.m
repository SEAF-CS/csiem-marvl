...
% Models
master.ncfile(1).name = 'W:\WAMSI\1.7\SH-20251123-1.7.0\2023A-20251124131331\results\csiem_A002_20221101_20240401_WQ_WQ.nc';
...
%master.ncfile(2).name = '/Projects2/csiem/Model/TFV/csiem_model_tfvaed_1.0/tfvaed_1.0/outputs/results_IMOS/csiem_100_A_20220101_20221231_WQ_009_WWM_WRF_GW_NAR_IMOS_WQ.nc';
%'E:\database\csiem_100_A_20130101_20130601_WQ_009_diag_1_WQ.nc';
%'E:\database\csiem_100_A_20130101_20130601_WQ_009_WQ_plot_ks.nc';
%master.ncfile(2).legend = 'oldMZ';
%master.ncfile(2).tag = 'TFV';

% field data
master.add_fielddata = 1;
master.fielddata_folder = 'G:\CSIEM\1.7.0\csiem-data\data-warehouse\mat\agency\';    
master.fielddata_files  = {'csiem_WAMSI_public','csiem_DWER_public'};
...
timeseries.polygon_file = 'G:\CSIEM\1.7.0\csiem-marvl\gis\Zones\MLAU_Zones_v3_ll.shp';
timeseries.plotAllsites = 0;
if timeseries.plotAllsites == 0
    timeseries.plotsite = [4 5 6 10];
end
...
timeseries.outputdirectory = '../../outputs/001_ValidationSnapshot/Kd/RAW/';
timeseries.htmloutput = '../../outputs/001_ValidationSnapshot/Kd/HTML/';
timeseries.ErrFilename = '../../outputs/001_ValidationSnapshot/Kd/errormatrix.mat';
