...
master.fielddata_folder = 'J:\1.7.0\csiem-data\data-warehouse\mat\agency\';
master.fielddata_files  = {'csiem_WAMSI_public','csiem_DWER_public_reduced50'};
...
timeseries.polygon_file = 'G:\CSIEM\1.7.0\csiem-marvl\gis\Zones\sensor_locations_v1.shp';
timeseries.plotAllsites = 0;
if timeseries.plotAllsites == 0
    timeseries.plotsite = [17 18 19 20 21 29];
end
...
timeseries.outputdirectory = '../../outputs/007_1.7_validation/2023A_turb2c/RAW/';
timeseries.htmloutput = '../../outputs/007_1.7_validation/2023A_turb2c/HTML/';
timeseries.ErrFilename = '../../outputs/007_1.7_validation/2023A_turb2c/errormatrix.mat';
...
timeseries.datearray = datenum(2022,16:22,1); % time period to plot
