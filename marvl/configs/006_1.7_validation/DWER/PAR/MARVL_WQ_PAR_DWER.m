...
if timeseries.plotAllsites == 0
    timeseries.plotsite = [29 30 33 36];
end
...
timeseries.outputdirectory = '../../../../outputs/001_ValidationSnapshot/DWER/PAR/RAW/';
timeseries.htmloutput = '../../../../outputs/001_ValidationSnapshot/DWER/PAR/HTML/';
timeseries.ErrFilename = '../../../../outputs/001_ValidationSnapshot/DWER/PAR/errormatrix.mat';
...
timeseries.datearray = datenum(2022,11:25,1); % time period to plot
