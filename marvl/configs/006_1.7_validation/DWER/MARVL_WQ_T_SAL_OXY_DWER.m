...
master.varname = {...
    ...
    %'WQ_DIAG_NCS_D_TAUB','DTAUB';...
    %'WQ_DIAG_NCS_RESUS','RESUS';...
    };
master.add_human = 1; % option to use user-define names, if 0 use AED names

% Models
master.ncfile(1).name = 'W:\WAMSI\1.7\SH-20251123-1.7.0\2022A-20251123030502\results\csiem_A002_20211101_20221231_WQ_WQ.nc';
master.ncfile(1).legend = 'csiem 1.7.0';
master.ncfile(1).tag = 'TFV';

master.ncfile(2).name = 'W:\WAMSI\1.7\SH-20251123-1.7.0\2023A-20251124131331\results\csiem_A002_20221101_20240401_WQ_WQ.nc';
master.ncfile(2).legend = 'csiem 1.7.0';
master.ncfile(2).tag = 'TFV';

master.ncfile(3).name = 'W:\WAMSI\1.7\SH-20251123-1.7.0\2021A-20251123030106\results\csiem_A002_20201101_20211231_WQ_WQ.nc';
master.ncfile(3).legend = 'csiem 1.7.0';
...
master.fielddata_folder = '../../../../csiem-data/data-warehouse/mat/agency/';
master.fielddata_files = {'csiem_DWER_public.mat.bak_20260219_131809'};
...
timeseries.polygon_file = '../../../gis/Zones/sensor_locations_v1.shp';

timeseries.plotAllsites = 0;
if timeseries.plotAllsites == 0
    timeseries.plotsite = [29 30 31 32 33 34 35];
end
...
timeseries.outputdirectory = '../../../outputs/001_ValidationSnapshot/DWER/T_SAL_OXY/RAW/';
timeseries.htmloutput = '../../../outputs/001_ValidationSnapshot/DWER/T_SAL_OXY/HTML/';
timeseries.ErrFilename = '../../../outputs/001_ValidationSnapshot/DWER/T_SAL_OXY/errormatrix.mat';
...
timeseries.ncfile(3).colour = {[255,127,0]./255;[140,86,75]./255};% Surface and Bottom
timeseries.ncfile(3).col_pal_color_surf =[[254,232,200]./255;[252,141,89]./255]; % color1: 5-95 perc; color2: 25-75 perc
timeseries.ncfile(3).col_pal_color_bot  =[[222,235,247]./255;[107,174,214]./255];


% plotting configuration
timeseries.datearray = datenum(2020,12:60,1);% time period to plot
...
axis_map = {
    ...
    'WQ_DIAG_TOT_TURBIDITY',[0     15];     % NTU
