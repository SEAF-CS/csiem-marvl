...
% Modelscsiem-marvl\configs\004_1.6_validation\001_CustomValidation\OXY_T_WWMSP5\RUN_MARVL_WQ_OXY_T_WWMSP5.m
master.ncfile(1).name = 'W:\WAMSI\1.7\SH-20251123-1.7.0\2022A-20251123030502\results\csiem_A002_20211101_20221231_WQ_WQ.nc';
master.ncfile(1).legend = 'csiem1.7.0 -2022';
master.ncfile(1).tag = 'TFV';

%master.ncfile(2).name = 'W:\WAMSI\1.7\SH-20251121-1.7.test\2023A-20251121074816\results\csiem_A001_20221101_20240401_WQ_WQ.nc';
%master.ncfile(2).legend = 'csiem1.7 -2023';
...
timeseries.depthTHRESH = -0.5;  %  {'surface','bottom'} Cell-array with either one
...
if timeseries.plotAllsites == 0
    timeseries.plotsite = [23 25 26 27 28];
end
...
timeseries.outputdirectory = '../../../../outputs/001_ValidationSnapshot/PAR_WWMSP5/P1/RAW/';
timeseries.htmloutput = '../../../../outputs/001_ValidationSnapshot/PAR_WWMSP5/P1/HTML/';
timeseries.ErrFilename = '../../../../outputs/001_ValidationSnapshot/PAR_WWMSP5/P1/errormatrix.mat';
...
timeseries.datearray = datenum(2021,11,15):7:datenum(2021,12,30);
...
for m = 1:size(axis_map,1)
    ...
    idxs = find(strcmp(var_codes, name));   
    for k = 1:numel(idxs)
