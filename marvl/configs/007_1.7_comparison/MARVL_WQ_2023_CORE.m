...
master.ncfile(1).legend = 'csiem1.7.a';
master.ncfile(1).tag = 'TFV';
%master.ncfile(2).name = '/Projects2/csiem/model/csiem_model_tfvaed_1.6/outputs/results/csiem_A001_20221101_20240401_WQgw_WQ.nc';
%master.ncfile(2).legend = 'csiem1.6.0';
%master.ncfile(2).tag = 'TFV';
%master.ncfile(3).name = '/Projects2/csiem/model/csiem_model_tfvaed_2.0/output_archive/results/csiem_A001_20221101_20240401_ECO_bivfb_WQ.nc';
%master.ncfile(3).legend = '2.0A';
...
timeseries.outputdirectory = '../../outputs/007_1.7_validation/2023-new_zone_full/RAW/';
timeseries.htmloutput = '../../outputs/007_1.7_validation/2023-new_zone_full/HTML/';
timeseries.ErrFilename = '../../outputs/007_1.7_validation/2023-new_zone_full/errormatrix.mat';
