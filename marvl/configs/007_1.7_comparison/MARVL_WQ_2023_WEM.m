    ...
    'WQ_DIAG_PHY_MPB_BEN','MPB (µg/L)'; ...
        ...
        'WQ_DIAG_TOT_EXTC','Light Extinction (1/m)'; ...
            ...
            'WQ_DIAG_TOT_PAR','PAR (W/m2)'; ...
                'WQ_NCS_SS1','Suspended Solids 1 (mg/L)'; ...
         'WQ_NCS_SS2','Suspended Solids 2 (mg/L)'; ...
            'WQ_NIT_AMM','Ammonium (mg/L)'; ...
        'WQ_DIAG_PHY_MPB_RES','MPB resuspension (mmol/m2/d)'; ...
...
master.ncfile(1).name = '/Projects2/csiem/model/csiem_model_tfvaed_1.7/output_archive/2023A/csiem_A001_20221101_20240401_WQ_WQ.nc';
master.ncfile(1).legend = 'csiem1.7.resus';
master.ncfile(1).tag = 'TFV';

master.ncfile(2).name = '/Projects2/csiem/model/csiem_model_tfvaed_1.7/output_archive/2023A-wem/csiem_A001_20221101_20240401_WQ_WQ.nc';
master.ncfile(2).legend = 'csiem1.7.wem2';
...
timeseries.outputdirectory = '../../outputs/007_1.7_validation/2023-resusD-wem2/RAW/';
timeseries.htmloutput = '../../outputs/007_1.7_validation/2023-resusD-wem2/HTML/';
timeseries.ErrFilename = '../../outputs/007_1.7_validation/2023-resusD-wem2/errormatrix.mat';
...
timeseries.datearray = datenum(2022,11:15,1); % time period to plot
