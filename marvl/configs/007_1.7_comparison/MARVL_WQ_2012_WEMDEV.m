...
master.ncfile(1).name = 'W:\WAMSI\1.7\SH-20251123-1.7.0\2013A-20251123024141\results\csiem_A002_20121101_20131231_WQ.nc';
master.ncfile(1).legend = 'csiem1.7.0_AED_LOCAL';
master.ncfile(1).tag = 'TFV';

master.ncfile(2).name = 'G:\CSIEM\csiem-platform\20251207-Config-Test\csiem_1_7_0_version_test\AED_Senteint\csiem_A002_20121101_20131231_WQ.nc';
master.ncfile(2).legend = 'csiem1.7.0_AED_SENT';
master.ncfile(2).tag = 'TFV';

master.ncfile(3).name = 'G:\CSIEM\csiem-platform\20251207-Config-Test\csiem_1_7_0_version_test\WEM_Sentient\wem_vali_A001_20121101_20131231_WQ_004_WQ.nc';
master.ncfile(3).legend = 'csiem1.7.0_WEM_SENT';
master.ncfile(3).tag = 'TFV';

% field data
master.add_fielddata = 0;
master.fielddata_folder = 'G:\CSIEM\1.7.0\csiem-data\data-warehouse\mat\agency\';
...
timeseries.end_plot_ID = 25;
%timeseries.start_plot_ID = 5;
%timeseries.end_plot_ID = 5;

timeseries.plotvalidation = 0; % Add field data to figure (true or false)
...
timeseries.outputdirectory = '../../outputs/007_1.7_validation/2012A/RAW/';
timeseries.htmloutput = '../../outputs/007_1.7_validation/2012A/HTML/';
timeseries.ErrFilename = '../../outputs/007_1.7_validation/2012A/errormatrix.mat';
...
timeseries.ncfile(3).colour = {[241,105,19]./255; [23,190,207]./255};          % Sup / Bot
timeseries.ncfile(3).col_pal_color_surf = [[253,208,162]./255; [253,141,60]./255]; % 5‑95 vs 25‑75
timeseries.ncfile(3).col_pal_color_bot  = [[204,236,230]./255; [102,194,164]./255];


% plotting configuration
timeseries.datearray = datenum(2012,11:24,1); % time period to plot
